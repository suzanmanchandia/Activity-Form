...
{{ Form::model($entry, array('route' =>  array('form.update', $entry->id), 'id' => 'form_entry', 'class' => 'form-ajax')) }}
...
<div class="tab-content form-pane">
  ...
  <div class="tab-pane fade" id="pro">
    ...
    <hr>
    <label class="control-label">Your scholarly lectures, panel discussions and workshops.</label>
  ...
  <div class="tab-pane " id="media">
    ...
    @include('utils.uploadEdit', ['label' => 'Please upload a current copy of your resume. ', 'name' => 'resume', 'id' => $entry->id, 'filters' => '.pdf,.doc,.docx,.rtf', 'files' => $entry->existingFiles('resume') ,'existing' => $entry->existingFilesJson('resume')])
    ...
    @include('utils.uploadEdit', ['label' => 'File ' . $counter, 'name' => 'syllabus'.$counter, 'id' => $entry->id, 'filters' => '.pdf,.doc,.docx,.rtf', 'files' => $entry->existingFiles('syllabus'.$counter, 'Syllabus ' . $counter) ,'existing' => $entry->existingFilesJson('syllabus'.$counter, 'Syllabus ' . $counter)])
