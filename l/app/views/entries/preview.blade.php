...
<hr>
        ...
        <h4>MEDIA / FILES</h4>
        <p>Resume</p>
        @include('utils.preview', ['label' => 'Resume', 'name' => 'resume', 'files' => $entry->existingFiles('resume')])
        <hr>
        ...
        @include('utils.preview', ['label' => 'File ' . $counter, 'name' => 'syllabus'.$counter, 'files' => $entry->existingFiles('syllabus'.$counter, 'Syllabus ' . $counter)])
